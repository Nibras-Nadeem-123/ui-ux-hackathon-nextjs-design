    ...
    <div>
      ...
      <div className='relative bg-[url("/page7Bg.jpg")] bg-cover h-[410px] w-full bg-center'>
         <div className='absolute inset-0 bg-black/30 my-auto mx-auto'>
            <p className={`${text.className} text-white text-[48px] mt-[168px] ml-[580px]`}>Sign In Page</p>
            <p className={`${inter.className} text-white text-[20px] ml-[610px] mt-3`}><Link href={"/blog"} className='hover:text-[#FF9F0D] cursor-pointer'>Page</Link> &gt; <span>Sign in page</span></p>
         </div>
     </div>
       <div className='h-full w-full px-96 ml-20 py-40'>
        <form onSubmit={handleSubmit} className='h-[594px] w-[564px] shadow-md shadow-[#E0E0E0] p-5'>
          {/* sign in heading */}
          <p className={`${text.className} text-center mb-5 text-[20px] text-[#333333]`}>Sign In</p>
          ...
          <div className='mt-6 text-center'>
            <button
              type='submit'
              className='w-[360px] h-[44px] bg-[#FF9F0D] hover:bg-amber-600 text-white rounded-md font-bold'
            >
              Sign In
            </button>
          </div>
          ...
          <div className='text-right mr-20 mt-5'>
            <Link href={"/contact"} style={{fontWeight: 400}} className={`${text.className} hover:underline hover:text-blue-500 text-right text-[14px] text-[#828282]`}>Forget password?</Link>
          </div>
          {/* border line */}
