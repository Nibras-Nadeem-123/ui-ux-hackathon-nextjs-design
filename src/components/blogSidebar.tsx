...
import PopularTags from '@/components/blogPage/blogDetails/popularTags';
import PhotoGallery from '@/components/blogPage/blogDetails/photoGallery';
import SocialFollow from '@/components/blogPage/blogDetails/socialFollow';
import ProfileCard from '@/components/blogPage/blogDetails/profileCard';
import RecentPosts from '@/components/blogPage/blogDetails/recentPost';
import FilterByMenu from '@/components/blogPage/blogDetails/filterByMenu';
