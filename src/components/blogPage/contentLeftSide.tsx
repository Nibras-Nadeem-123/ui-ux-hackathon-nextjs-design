...
const ContentLeftSide = () => {
  return (
    <div className="max-w-full px-4 sm:px-6 md:px-8">
        {/* 1st blog */}
      <div className='w-full max-w-[872px] h-auto mt-[50px]'>
        <Image src={"/blogLeftSide.jpg"} alt='' height={320} width={671} className='cursor-pointer w-full'/>
        ...
        <div className='border-b-2 border-[#828282] opacity-[50%] w-[594.03px] mt-5'></div>
        <div className='w-full max-w-[647.26px] h-[96px] mt-9'>
        ...
        <button className='flex gap-2 w-[192px] h-[52px] mt-7 rounded-[6px] border-2 border-[#FF9F0D] hover:shadow-md hover:shadow-gray-400 py-[14px] px-[32px]'>
          <p style={{fontWeight: 400}} className={`${text.className} text-[16px] text-[#FF9F0D]`}>Read More </p>
          <PiArrowLineUpRight className='text-[#FF9F0D] h-[24px] w-[24px]'/>
        </button>
      </div>
      
      {/* 2nd blog */}
      <div className='w-full max-w-[872px] h-auto mt-[20px]'>
        <Image src={"/blogLeftSide2.jpg"} alt='' height={320} width={671} className='cursor-pointer w-full'/>
        <div className={`${inter.className} flex space-x-3 mt-2`}>
            <IoCalendarNumberOutline className='text-[#FF9F0D] w-[23.97px] h-[24px]'/>
            <p>Feb 14, 2022 /</p>
           <PiChats className='text-[#FF9F0D] w-[23.97px] h-[24px]'/> 
      ...
      {/* third blog */}
      <div className='w-full max-w-[872px] h-auto mt-[20px]'>
        <Image src={"/blogLeftSide3.jpg"} alt='' height={320} width={671} className='cursor-pointer w-full'/>
        <div className={`${inter.className} flex space-x-3 mt-2`}>
            <IoCalendarNumberOutline className='text-[#FF9F0D] w-[23.97px] h-[24px]'/>
            <p>Feb 14, 2022 /</p>
           <PiChats className='text-[#FF9F0D] w-[23.97px] h-[24px]'/> 
      ...
      {/* fourth blog */}
      <div className='w-full max-w-[872px] h-auto mt-[20px]'>
        <Image src={"/blogLeftSide4.jpg"} alt='' height={320} width={671} className='cursor-pointer w-full'/>
        <div className={`${inter.className} flex space-x-3 mt-2`}>
            <IoCalendarNumberOutline className='text-[#FF9F0D] w-[23.97px] h-[24px]'/>
            <p>Feb 14, 2022 /</p>
           <PiChats className='text-[#FF9F0D] w-[23.97px] h-[24px]'/> 
